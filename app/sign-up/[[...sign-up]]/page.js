...
export default function SignUpPage() {
  return (
    <ThemeProvider theme={darkTheme}>
      <CssBaseline />
      <Head>
        <title>Sign Up | PromptWise</title>
        <meta name="description" content="Create your PromptWise account" />
        <link
      ...
      <Box
        sx={{
          ...
          backgroundImage:
            'radial-gradient(circle at 70% 50%, rgba(108, 99, 255, 0.08), transparent 40%), radial-gradient(circle at 30% 20%, rgba(99, 236, 255, 0.05), transparent 30%)',
        }}
      >
        {/* App Bar */}
        <AppBar
